...
export default async function TutorDetailsPage({
  params,
}: TutorDetailsPageParams) {
  const { id } = await params;

  const data = await getTutorByID(id);
  const tutor: ITutorDetails = data?.data || [];
  const {
    name,
    image,
    user,
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-gray-100">
      ...
      <div className="bg-linear-to-r from-violet-600 to-violet-700 text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-3xl shadow-lg overflow-hidden">
              <div className="p-8 bg-linear-to-br from-violet-50 to-white">
                <div className="flex items-start gap-6 mb-8">
                  <div className="w-28 h-28 rounded-full bg-linear-to-br from-violet-200 to-violet-100 ring-4 ring-violet-100 flex items-center justify-center text-6xl shrink-0 shadow-md">
                    {image}
                  </div>
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 font-medium mb-4">sdfs</p>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {subjects?.map((subject) => (
                        <div
                          ...
                          className="inline-block bg-linear-to-r from-violet-100 to-violet-50 text-violet-700 rounded-full px-4 py-2 text-sm font-semibold shadow-sm"
                        >
            ...
            <div className="sticky top-24 bg-white rounded-3xl shadow-xl overflow-hidden">
              {/* <div className="bg-gradient-to-r from-violet-600 to-violet-700 text-white p-8">
                ...
                <p className="text-violet-200 text-sm flex items-center gap-1">
                  <span className="text-lg">★</span> {tutor.rating} ·{" "}
              ...
              {/* <div className="p-6 space-y-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                      {tutor.slots.map((slot, idx) => (
                        <button
                          ...
                          className={`w-full px-4 py-3 rounded-xl text-sm font-semibold transition-all duration-200 text-left flex items-center gap-2 ${
                            selectedSlot === idx
                ...
                <button
                  ...
                  className={`w-full py-4 rounded-xl font-bold text-base transition-all duration-200 flex items-center justify-center gap-2 ${
                    selectedSlot !== null && tutor.available
