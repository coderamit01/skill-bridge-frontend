...
export const WelcomeCard = async () => {
  ...
  const name = header.get("x-user-name") || "User";
        ...
        <div className="flex media-wrapper justify-between">
          <div className="grow text-white">
            <div className="greeting-user">
              <h2 className="text-xl font-semibold line-clamp-1">Welcome {name}!</h2>
              <p className="line-clamp-2">Here whats happing in your<br /> account today</p>
              <div className="pt-10">
                <Link href="/dashboard/profile" className="text-sm border border-slate-50 rounded-md py-2 px-3 hover:bg-white hover:text-slate-700">View Profile</Link>
              </div>
            </div>
          </div>
          <div>
